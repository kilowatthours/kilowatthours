...
#    AUTHOR:	Ken Hughes                                                    #
#                                                                             #
#    Copyright 2020 - Ken Hughes - All rights reserved                        #
###############################################################################
...
if __name__ == '__main__':
    ...
    print(
        color.UNDERLINE + 'Name'.ljust(46) + "|" + 'Size'.rjust(26) + color.END
        )
    ...
    print(
        "|" + color.GREEN +
        bucket.name.ljust(45) + color.END +
        "|" + color.PURPLE +
        humansize(size).rjust(25) + color.END + "|"
        )
